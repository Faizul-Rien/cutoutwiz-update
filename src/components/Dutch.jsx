...
Afbeelding en video</p>
                ...
                <div className="row">
                  ...
                  <a className="" href="https://app.cutoutwiz.com/"target="_blank"><button className="button1">GRATIS PROEF</button> </a></div>
      ...
      <div className="row">
          ...
          <div className="card" style={{border:"black",width: "100%",borderRadius:"10px",backgroundColor:"#e3e6d8",color:"white",boxShadow:"1px 2px 3px 4px rgba(12,12,12,0.2)"}}>
              ...
              <div className="card-body"style={{marginTop:"-3%"}}>
                ...
                <p className="card-text"style={{marginTop:"-7%",fontWeight:"500",color:"#000000"}}>Afbeelding<br/>Dagelijks verwerkt</p>
              </div>
              </div>
          </div>
          ...
          <div className="card" style={{border:"black",width: "100%",borderRadius:"10px",backgroundColor:"#e3e6d8",color:"white",boxShadow:"1px 2px 3px 4px rgba(12,12,12,0.2)"}}>
              ...
              <div className="card-body"style={{marginTop:"-3%"}}>
                ...
                <hr style={{width:"32%",border:"1px solid #000000",backgroundColor:"#000000",opacity:"1",marginTop:"-1%"}}></hr>
                <p className="card-text"style={{marginTop:"-7%",fontWeight:"500",color:"#000000"}}>Team<br/>Leden</p>
              </div>
              </div>
          </div>
          ...
          <div className="card" style={{border:"black",width: "100%",borderRadius:"10px",backgroundColor:"#e3e6d8",color:"white",boxShadow:"1px 2px 3px 4px rgba(12,12,12,0.2)"}}>
              ...
              <div className="card-body"style={{marginTop:"-3%"}}id="text">
                <h4 style={{color:"#000000"}}  className="card-title">365 Dagen</h4>
                <hr style={{width:"32%",border:"1px solid #000000",backgroundColor:"#000000",opacity:"1",marginTop:"-1%"}}></hr>
                <p className="card-text"style={{marginTop:"-7%",fontWeight:"500",color:"#000000"}}>Klant<br/>Steun
</p>
              </div>
              </div>
          </div>
          ...
          <div className="card" style={{border:"black",width: "100%",borderRadius:"10px",backgroundColor:"#e3e6d8",color:"white",boxShadow:"1px 2px 3px 4px rgba(12,12,12,0.2)"}}>
              ...
              <div className="card-body"style={{marginTop:"-3%"}}>
                <h4 style={{color:"#000000"}}  className="card-title">12 Uren</h4>
                <hr style={{width:"32%",border:"1px solid #000000",backgroundColor:"#000000",opacity:"1",marginTop:"-1%"}}></hr>
                <p className="card-text"style={{marginTop:"-7%",fontWeight:"500",color:"#000000"}}>Of minder<br/>Tijd om te bezorgen</p>
              </div>
              </div>
          </div>
          ...
          <div className="card" style={{border:"black",borderRadius:"10px",width: "100%",backgroundColor:"#e3e6d8",color:"white",boxShadow:"1px 2px 3px 4px rgba(12,12,12,0.2)"}}>
              ...
              <div className="card-body"style={{marginTop:"-3%"}}>
                ...
                <hr style={{width:"32%",border:"1px solid #000000",backgroundColor:"#000000",opacity:"1",marginTop:"-1%"}}></hr>
                <p className="card-text"style={{marginTop:"-7%",fontWeight:"500",color:"#000000"}}>Vrij<br/>Proefafbeeldingen</p>
              </div>
              </div>
              </div>
          </div>
...
<img src="assets/images/round for services.png"style={{ position: "absolute",
  ...
  <div className="col-md-5">
   ...
   <div className="quotea"><p style={{fontSize:"46px"}}>AFBEELDING</p>
    <p   id="testret-re">MASKEREN</p>
    </div>


    <div className="quotea" ><p style={{fontSize:"46px"}}>GEEST</p>
    ...
    <div className="quotea" ><p style={{fontSize:"46px"}}>SCHADUW</p>
    ...
    <div className="quotea"><p style={{fontSize:"46px"}}>KLEUR</p>
    ...
    <div className="quotea"><p style={{fontSize:"46px"}}>ACHTERGROND</p>
...
<div id="refresh">
  ...
  <img src="assets/images/bannertest.png"style={{ position: "absolute",
            ...
            <div id="cf3">
            <div className="quot"><p style={{fontSize:"46px",color:"#e4801c"}}>AFBEELDING</p>
             <p   id="testret-re">MASKEREN</p>
           </div>
              <img className="bottom" src="assets/images/Hair-Masking-after.png" height="100%" width="65%"style={{left:"7%" }}  />
              <img className="top" src="assets/images/Hair-Masking-before.png"height="100%" width="65%"style={{left:"7%"}}  />
              ...
              <div id="cf3">
              <div className="quot"><p style={{fontSize:"46px"}}>GEEST</p>
             <p   id="testret-re">MANNEQUIN</p>
           </div>
                <img className="bottom" src="assets/images/Ghost manniquin-01.png" height="100%" width="80%"  />
                <img className="top" src="assets/images/Ghost manniquin-02.png"height="100%" width="80%" />
             ...
             <p   id="testret-re">HERKLEUREN</p>
              ...
              <img className="bottom" src="assets/images/recolor-02.png"height="100%" width="80%" />
                ...
                <div id="cf3">
                <div className="quot"><p style={{fontSize:"46px"}}>SCHADUW</p>
                 <p   id="testret-re">CREATIE</p>
                </div>
              ...
              <div id="cf3">
              <div className="quot"><p style={{fontSize:"46px"}}>KLEUR</p>
                <p   id="testret-re">CORRECTIE</p>
              </div>
              ...
              <div id="cf3">
              <div className="quot"><p style={{fontSize:"46px"}}>AFBEELDING</p>
            ...
            <div id="cf3">
              <div className="quot"><p style={{fontSize:"46px"}}>ACHTERGROND</p>
      ...
      <div>
        <br/>
          ...
          <img src="assets/images/S-1.png"  width="30%" height="30%" alt="Image icon"/><br/>
              <div className="card-body">
                <h4 className="card-title">Stap 1:</h4>
                <hr style={{width:"32%",border:"1px solid #ffcc33",backgroundColor:"#ffcc33",opacity:"1",marginTop:"-1%"}}></hr>
                <p className="card-text"id="btmspace" style={{fontWeight:"700",fontSize:"13px"}}>Log in <br/> <span  style={{color:"white"}}>preferred subscription</span> </p>
              </div>
          ...
          <div className="card" style={{width: "100%",borderRadius:"10px",boxShadow:"1px 2px 3px 4px rgba(12,12,12,0.2)",border:"black"}}>
              ...
              <div className="card-body">
                <h4 className="card-title">Stap 2:</h4>
                <hr style={{width:"32%",border:"1px solid #ffcc33",backgroundColor:"#ffcc33",opacity:"1",marginTop:"-1%"}}></hr>
                <p className="card-text"style={{fontWeight:"700",fontSize:"13px"}}>Choose your<br/>voorkeur abonnement<span id="prefer" style={{color:"white"}}><br/>preferred</span></p>
              </div>
              </div>
          </div>
          ...
          <img src="assets/images/S-3.png"  width="30%" height="30%" alt="Image icon"/><br/>
              ...
              <div className="card-body">
                <h4 className="card-title">Stap 3:</h4>
                <hr style={{width:"32%",border:"1px solid #ffcc33",backgroundColor:"#ffcc33",opacity:"1",marginTop:"-1%"}}></hr>
                <p className="card-text"style={{fontWeight:"700",fontSize:"13px"}}>Ga naar je<br/>account om een ​​bestelling te plaatsen</p>
              </div>
              </div>
          </div>
          ...
          <img src="assets/images/S-4.png"  width="30%" height="30%" alt="Image icon"/><br/>
              <div className="card-body">
                <h4 className="card-title">Stap 4:</h4>
                <hr style={{width:"32%",border:"1px solid #ffcc33",backgroundColor:"#ffcc33",opacity:"1",marginTop:"-1%"}}></hr>
                <p className="card-text"style={{fontWeight:"700",fontSize:"13px"}}>Upload de<br/>afbeeldingen die u door ons wilt laten bewerken</p>
              </div>
              </div>
          </div>
          ...
          <img src="assets/images/S-5.png"  width="30%" height="30%" alt="Image icon"/><br/>
              <div className="card-body">
                <h4 className="card-title">Stap 5:</h4>
                <hr style={{width:"32%",border:"1px solid #ffcc33",backgroundColor:"#ffcc33",opacity:"1",marginTop:"-1%"}}></hr>
                <p className="card-text"style={{fontWeight:"700",fontSize:"13px"}}>De beste foto-editor<br/>verwerk de foto's voor je</p>
              </div>
              </div>
          </div>
          ...
          <img src="assets/images/S-6.png"  width="30%" height="30%" alt="Image icon"/><br/>
              <div className="card-body">
                <h4 className="card-title">Stap 6:</h4>
                <hr style={{width:"32%",border:"1px solid #ffcc33",backgroundColor:"#ffcc33",opacity:"1",marginTop:"-1%"}}></hr>
                <p  className="card-text"style={{fontWeight:"700",fontSize:"13px"}}>Downloaden<br/>de bewerkte foto's<span id="prefer"  style={{color:"white"}}>for you</span></p>
              </div>
              </div>
          </div>
...
<div className="row" id="fot-phn">
    ...
    <p style={{textAlign:"justify",color:"#01302b",marginTop:"4%",fontWeight:"500"}}>The KOW Company is een van de toonaangevende bedrijven voor beeld- en videobewerking voor bedrijven over de hele wereld.</p>
    ...
    <p style={{textAlign:"center",color:"white",padding:"8px",backgroundColor:"black"}}>Ontworpen en ontwikkeld door <Link to="/" target="_blank"  style={{textDecoration:"none",color:"white"}}>The KOW Company</Link></p>
