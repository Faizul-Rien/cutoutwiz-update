...
<img src="../../assets/images/Watch editing in an editing software.jpg" className="rounded mx-auto d-block"  width="80%" height="20%" alt="watch-editing-in-an-editing-software"/>
<br/>
